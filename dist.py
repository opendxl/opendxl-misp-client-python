...
VERSION = __import__('dxlmispclient').get_version()
RELEASE_NAME = "dxlmispclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlmispclient")])
...
print("\nRemoving dxlmispclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlmispclient.egg-info"))
